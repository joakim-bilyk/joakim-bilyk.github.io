...
\textbf{Proposition 1. (\(\rho\)-modified Kolmogorov)}\index{$\rho$-modified Kolmogorov} \emph{Let the \(\rho\)-modified transition probabilities be given by (1). For \(i,j\in\mathcal J\) we have}
...
\includegraphics{theory_files/figure-latex/unnamed-chunk-16-1.pdf}
...
\includegraphics{theory_files/figure-latex/unnamed-chunk-17-1.pdf}
...
\begin{center}\includegraphics[width=0.25\linewidth]{theory_files/figure-latex/unnamed-chunk-22-1} \end{center}
...
\begin{center}\includegraphics[width=0.4\linewidth]{theory_files/figure-latex/unnamed-chunk-23-1} \end{center}
