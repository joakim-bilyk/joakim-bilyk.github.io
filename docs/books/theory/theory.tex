...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.6923}}@{}}
\toprule()
...
\hypertarget{finite-time-lundberg-inequalities-1}{%
\subsection{Finite time Lundberg inequalities}\label{finite-time-lundberg-inequalities-1}}
