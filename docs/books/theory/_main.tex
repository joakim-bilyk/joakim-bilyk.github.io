...
\AtBeginDocument{%
  ...
  \addtolength\abovedisplayshortskip{-0.75\baselineskip}%
...
&+V_t^{Z(t)}(t,X(t))\ dt+V_x^{Z(t)}(t,X(t))\ dX(t)+\frac{1}{2}V_{xx}^{Z(t)}(t,X(t))\ \big(dX(t)\big)^2\\
...
\begin{align*}
dX(t)&=rX(t)\ dt+\pi(t,X(t-))\sigma X(t)\ dW^\mathbb Q(t)\\
&-dA^{Z(t)}(t,X(t-))-\sum_{k:k\ne Z(t-)}\lambda_{Z(t-)k}\varrho^{Z(t-)k}(t,X(t))\ dt\\
&=rX(t)\ dt+\pi(t,X(t-))\sigma X(t)\ dW^\mathbb Q(t)\\
&-a^{Z(t)}(t,X(t-))\ dt -\Delta A^{Z(t)}(t,X(t-))\\
&-\sum_{k:k\ne Z(t-)}\lambda_{Z(t-)k}\varrho^{Z(t-)k}(t,X(t))\ dt\\
\big(dX(t)\big)^2&=\pi^2(t,X(t-))\sigma^2 X^2(t)\ dt + jumps
\end{align*}
...
&+V_t^{Z(t)}(t,X(t))\\
&+V_x^{Z(t)}(t,X(t))\\
&\left(rX(t)-a^{Z(t)}(t,X(t-))-\sum_{k:k\ne Z(t-)}\lambda_{Z(t-)k}\left(\varrho^{Z(t-)k}(t,X(t))+\chi^{Z(t)}(t,X(t-))-X(t-)\right)\right)\\
&+\frac{1}{2}V_{xx}^{Z(t)}(t,X(t))\pi^2(t,X(t-))\sigma^2 X^2(t)\\
&+\sum_{k:k\ne Z(t-)}\left(V^{k}(t,\chi^k(t,X(t-)))-V^{Z(t-)}(t-,X(t-))\right)\lambda_{Z(t-)k}(t)
\end{align*}
Giving the desired PDE. On discontinuity points
\[
V^{Z(t)}\Big(t,X(t-)-\Delta A^{Z(t)}(t,X(t-)\Big)-V^{Z(t)}(t-,X(t-))=-\Delta B^{Z(t)}(t,X(t))
\]
as desired. \(\blacksquare\)
...
\begin{center}\includegraphics[width=0.25\linewidth]{_main_files/figure-latex/unnamed-chunk-17-1} \end{center}
...
\begin{center}\includegraphics[width=0.4\linewidth]{_main_files/figure-latex/unnamed-chunk-18-1} \end{center}
